        ...
        <html lang="en">
            ...
            <body>
                <div id="content">
                    ...
                    <p class="expl">Generated by <a href="https://spacecode.dev" target="_blank" title="SpaceCode">SpaceCode</a>. This is styled xml sitemap (for Google News), sorted by update date.</p>
                    <p class="expl">This sitemap contains
                        <xsl:value-of select="count(s:urlset/s:url)"/> URLs.
                    </p>
                    <table id="sitemap" class="tablesorter" border="1" cellpadding="3" width="100%">
                        <thead>
                            <tr bgcolor="#9acd32">
