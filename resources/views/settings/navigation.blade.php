<router-link tag="h3" :to="{name: 'maia-settings'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    ...
    <span class="sidebar-label">
        {{ _trans('maia::resources.sidebar.settings') }}
    </span>
</router-link>
