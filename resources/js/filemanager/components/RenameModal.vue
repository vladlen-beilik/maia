            ...
            <div class="bg-white rounded-lg shadow-lg " style="width: 600px;">
                <div class="p-8">
                    <template v-if="type === 'folder'">
                        ...
                        <input type="text" class="w-full h-full form-control form-input form-input-bordered py-3"
                               :placeholder="name" v-model="name" autofocus required v-on:keyup.enter="renamePath">
                    </template>
                    <template v-else>
                        <heading :level="2" class="mb-6">
                            {{ __('Rename file') }}
                        ...
                        <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                            <input type="text"
                                   ...
                                   :placeholder="nameWithoutExtension" v-model="nameWithoutExtension" autofocus required
                                   v-on:keyup.enter="renamePath">
                ...
                <div class="bg-30 px-6 py-3 flex">
                    <div class="ml-auto">
                        <button type="button" data-testid="cancel-button" @click.prevent="cancelRename"
                        ...
                        <button ref="confirmButton" data-testid="confirm-button" :disabled="isSaving"
                                @click.prevent="renamePath" class="btn btn-default btn-primary"
