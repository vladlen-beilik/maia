        ...
        <template v-if="view === 'grid'">
            ...
            >
                ...
                <div v-if="file.mime !== 'image'" v-html="file.thumb"
                     class="mime-icon flex items-center justify-center  h-5/6"></div>
                <div v-if="file.mime === 'image'" ref="image" class="image-block block w-full h-5/6"></div>
                <div class="actions-grid absolute pin-t pin-r pr-2 pt-2 pb-1 pl-2 "
                    ...
                    <div v-else class="flex flex-wrap text-70">
                        <div class="cursor-pointer" :class="{ ' mr-2' : renamePermission }" v-if="deletePermission"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-labelledby="delete" class="fill-current">
                ...
                <div class="missing p-8" v-if="missing">
                    <p class="text-center leading-normal">
                        <a :href="file.name" class="text-primary dim" target="_blank">{{__('This image')}}</a>
            ...
            <tr @click="clickStrategy" :loading="loading" v-bind:key="file.id" class="cursor-pointer">
                ...
                <td>
                    ...
                    <div class="w-full h-full flex justify-center items-center">
                        <div v-if="file.mime !== 'image'" v-html="file.thumb" class="mime-icon flex items-center justify-center w-1/3 h-full"></div>
                        <div v-if="file.mime === 'image'" ref="image" class="image-block block w-full h-full"></div>
                    </div>
