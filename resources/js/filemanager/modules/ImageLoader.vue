    ...
    <transition name="fade">
        <template v-if="view == 'grid'">
            ...
            >
                ...
                <div v-if="file.mime != 'image'" v-html="file.thumb" class="mime-icon flex items-center justify-center  h-5/6"></div>
                <div  v-if="file.mime == 'image'" ref="image" class="image-block block w-full h-5/6"></div>
                <div class="actions-grid absolute pin-t pin-r pr-2 pt-2 pb-1 pl-2 " :class="{ 'hidden': !multiSelecting , 'bg-50' : shouldShowHover}">
