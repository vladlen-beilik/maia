...
class PermissionBooleanGroup extends BooleanGroup
{
    public function __construct($name, $attribute = null, callable $resolveCallback = null)
    {
        ...
        if(!isBlog()) {
            $options = Arr::except($options, ['viewAny posts', 'view posts', 'create posts', 'update posts', 'attachCategory posts', 'detachCategory posts', 'attachTag posts', 'detachTag posts', 'delete posts', 'restore posts', 'forceDelete posts', 'viewAny postTags', 'view postTags', 'create postTags', 'update postTags', 'delete postTags', 'restore postTags', 'forceDelete postTags', 'viewAny postCategories', 'view postCategories', 'create postCategories', 'update postCategories', 'delete postCategories', 'restore postCategories', 'forceDelete postCategories']);
        }
        if(!isPortfolio()) {
            $options = Arr::except($options, ['viewAny portfolio', 'view portfolio', 'create portfolio', 'update portfolio', 'attachCategory portfolio', 'detachCategory portfolio', 'attachTag portfolio', 'detachTag portfolio', 'delete portfolio', 'restore portfolio', 'forceDelete portfolio', 'viewAny portfolioTags', 'view portfolioTags', 'create portfolioTags', 'update portfolioTags', 'delete portfolioTags', 'restore portfolioTags', 'forceDelete portfolioTags', 'viewAny portfolioCategories', 'view portfolioCategories', 'create portfolioCategories', 'update portfolioCategories', 'delete portfolioCategories', 'restore portfolioCategories', 'forceDelete portfolioCategories']);
        }
