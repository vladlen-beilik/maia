...
class PortfolioCategory extends Resource
{
     ...
     * @var string
     */
    public static $model = \SpaceCode\Maia\Models\PortfolioCategory::class;
    ...
    {
        return trans('maia::resources.portfolioCategories');
    }
    ...
    {
        return trans('maia::resources.portfolioCategory');
    }
            ...
            (new Tabs($this->singularLabel(), [
                ...
                trans('maia::resources.content') => [
                    ...
                    Image::make(trans('maia::resources.image'), 'image')
                        ->path('portfolioCategories/images')
                        ->prunable(),
                    ...
                    Slug::make(trans('maia::resources.slug'), 'slug')
                        ...
                        ->displayUsing(function () {
                            return url(seo('seo_portfolio_categories_prefix') . '/' . $this->slug);
                        })->asHtml(),
