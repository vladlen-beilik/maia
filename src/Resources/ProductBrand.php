...
class ProductBrand extends Resource
{
     ...
     * @var string
     */
    public static $model = \SpaceCode\Maia\Models\ProductBrand::class;
    ...
    {
        return _trans('maia::resources.productBrands');
    }
    ...
    {
        return _trans('maia::resources.productBrand');
    }
            ...
            (new Tabs($this->singularLabel(), [
                _trans('maia::resources.general') => [
                    ...
                    Select::make(_trans('maia::resources.template'), 'template')
                        ->options(getTemplate('productBrands'))
                        ->rules('required')
                        ->hideFromIndex()
                        ->displayUsingLabels()
                ],
                _trans('maia::resources.content') => [
                    ...
                    Slug::make(_trans('maia::resources.slug'), 'slug')
                        ...
                        ->updateRules('unique:product_brands,slug,{{resourceId}}'),
