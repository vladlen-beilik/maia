...
class Portfolio extends Resource
{
    ...
    {
        return _trans('maia::navigation.sidebar-portfolio');
    }
    ...
    {
        return _trans('maia::resources.portfolio');
    }
    ...
    {
        return _trans('maia::resources.singlePortfolio');
    }
        ...
        return [
            (new Tabs($this->singularLabel(), [
                ...
                _trans('maia::resources.categories') => [
                    BelongsToMany::make(_trans('maia::resources.categories'), 'categories', PortfolioCategory::class)->fields(function () {
                        return [
                ...
                _trans('maia::resources.tags') => [
                    BelongsToMany::make(_trans('maia::resources.tags'), 'tags', PortfolioTag::class)->fields(function () {
                        return [
