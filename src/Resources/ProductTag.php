...
class ProductTag extends Resource
{
     ...
     * @var string
     */
    public static $model = \SpaceCode\Maia\Models\ProductTag::class;
    ...
    {
        return _trans('maia::resources.productTags');
    }
    ...
    {
        return _trans('maia::resources.productTag');
    }
            ...
            (new Tabs($this->singularLabel(), [
                _trans('maia::resources.general') => [
                    ...
                    Select::make(_trans('maia::resources.template'), 'template')
                        ->options(getTemplate('productTags'))
                        ->rules('required')
                        ->hideFromIndex()
                        ->displayUsingLabels()
                ],
                _trans('maia::resources.content') => [
                    ...
                    Slug::make(_trans('maia::resources.slug'), 'slug')
                        ->onlyOnForms()
                        ->rules('required', 'max:255')
                        ->creationRules('unique:product_tags,slug')
                        ->updateRules('unique:product_tags,slug,{{resourceId}}'),
