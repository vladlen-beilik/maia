...
class Product extends Resource
{
    ...
    {
        return trans('maia::resources.products');
    }
    ...
    {
        return trans('maia::resources.product');
    }
        ...
        return [
            (new Tabs($this->singularLabel(), [
                trans('maia::resources.general') => [
                    ...
                    BelongsTo::make(trans('maia::resources.shop'), 'shop', Shop::class)->rules('required')
                        ->sortable()
                        ->withoutTrashed(),
                ...
                trans('maia::resources.warehouse') => [
                    Number::make(trans('maia::resources.amount'), 'amount')
                        ->min(0)
                        ->step(1)
                        ->rules('required')
                        ->sortable(),
                    ...
                    Text::make(trans('maia::resources.sales'), 'sales')
                        ->displayUsing(function () {
